(function(window){
  window.extractData = function() {
    ...
    function test_config_ESUrl(){
      alert("In extractData")	;
  	  alert (env_url);
    }
    ...
    //alert("version ES-1102-1AWindowOpen-CM-Baseline");
 ...
 function getPatientMRN(patient) {
  ...
  //window.redirectToES = function(patient, env_url){
  window.redirectToES = function(patient) {
	...
	{  
	    ...
	    var es_url="Not Available";
      }
if ( es_url !== "Not Available" ) { 	     
      var fname = '';
      var lname = '';
...
alert("In redirectToES");
alelt(env_url);
//var es_url = env_url + base64_text;
